...
export default function AdminManagementPage() {
  ...
  if (loading) {
    return (
      <PermissionGuard requiredPermission="users.manage_roles">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">
                Sadece süper admin erişimi - Admin kullanıcılarını yönetin
              </p>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-amber-700">
                  <strong>Dikkat:</strong> Bu bölüm sadece süper admin
                  kullanıcıları tarafından erişilebilir. Admin rollerini
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      admins.filter((a) => a.role === USER_ROLES.SUPER_ADMIN)
                        .length
                    }
                  </p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      admins.filter((a) => a.role === USER_ROLES.MODERATOR)
                        .length
                    }
                  </p>
                </div>
                  ...
                  {filteredAdmins.map((admin) => (
                    <tr key={admin.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {admin.lastLoginAt
                          ?.toDate?.()
                          ?.toLocaleDateString("tr-TR") || "Hiç giriş yapmamış"}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          ...
                          <select
                            value={admin.role}
                            onChange={(e) =>
                              handleRoleUpdate(admin.id, e.target.value)
                            }
