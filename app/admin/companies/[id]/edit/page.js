...
export default function EditCompanyPage() {
  ...
  const mockCompany = {
    ...
    contactPosition: "Pazarlama Müdürü",
    contactPhone: "+90 532 123 4567",
    contactEmail: "ahmet.yilmaz@techcorp.com",
    revenue: "2.5M TL",
    employees: "50-100",
    foundedYear: "2018",
    monthlyBudget: "15.000 TL",
    description:
      "Teknoloji alanında faaliyet gösteren, dijital çözümler sunan bir firma.",
    socialMedia: {
    ...
    tags: ["E-ticaret", "Dijital Pazarlama", "SEO", "Google Ads"],
    services: [
      "Web Tasarım",
      "SEO Optimizasyon",
      "Google Ads Yönetimi",
  ...
  const handleDelete = async () => {
    if (
      ...
      try {
        ...
        const { deleteCompany } = await import("../../../../../lib/services/companies-service");
