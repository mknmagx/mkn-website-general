...
export default function EditProformaPage() {
  ...
  if (authLoading || proformaLoading) return <div>Yükleniyor...</div>;
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              {proforma?.proformaNumber} numaralı proformayı düzenleyebilirsiniz
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-2 space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Kayıtlı Firmalardan Seç (İsteğe Bağlı)
                    </label>
                    <Select
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        Proformaya dahil edilecek hizmetleri yönetin
                      </CardDescription>
                    </div>
                    <div className="flex gap-2">
                      ...
                      >
                        <SelectTrigger className="w-48">
                          <SelectValue placeholder="Hizmet kategorisi seç..." />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="space-y-4">
                    ...
                    {formData.services.length === 0 && (
                      <div className="text-center py-8 text-gray-500">
                        Henüz hizmet eklenmemiş. Yukarıdaki butonları kullanarak
                        hizmet ekleyebilirsiniz.
                      </div>
                    )}
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Fiyatlandırma ve Şartlar</CardTitle>
                  <CardDescription>
                    Proforma fiyatlandırması ve şartlarını ayarlayın
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Geçerlilik tarihi şartlar ayarlarına göre otomatik
                      hesaplanır
                    </p>
                  </div>
