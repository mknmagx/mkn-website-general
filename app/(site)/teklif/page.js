        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 overflow-x-hidden">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg sm:text-xl text-blue-100 mb-6">
              Detaylı bilgilerinizi paylaşın, ihtiyacınıza özel teklifi 24 saat
              içinde alın
            </p>
                ...
                {isError && !showSubmissionModal && (
                  <Alert className="mb-6 border-red-200 bg-red-50 dark:bg-red-900/20 dark:border-red-800">
                    ...
                    <AlertDescription className="text-red-800 dark:text-red-200">
                      ...
                      {hasErrors && " Lütfen aşağıdaki alanları kontrol edin."}
                    </AlertDescription>
                  </Alert>
                )}
          ...
          <div className="max-w-4xl mx-auto overflow-x-hidden">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Formu doldururken soru işaretleriniz mi var? Uzman ekibimiz size
