...
export default function TeklifPage() {
  ...
  // Controlled input için optimize edilmiş handler
  const handleInputChange = useCallback((field, value) => {
    // Immediate state update - bu input'u controlled tutar
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
  ...
  // Seçimler için state güncellemesi yapan handler (hizmet alanı, select'ler vb.)
  ...
  const validateStep = (step) => {
    ...
    // DOM'dan güncel form verilerini al
    const currentFormData = collectFormData();

    switch (step) {
      case 1:
        if (!currentFormData.firstName.trim()) newErrors.firstName = "Ad zorunludur";
        if (!currentFormData.lastName.trim()) newErrors.lastName = "Soyad zorunludur";
        ...
        if (!currentFormData.phone.trim()) {
          ...
          const cleanPhone = currentFormData.phone.replace(/[\s\-\(\)]/g, "");
          if (!phoneRegex.test(cleanPhone)) {
            newErrors.phone = "Geçerli bir telefon numarası girin";
          }
        }
        if (!currentFormData.company.trim())
      ...
      case 2:
        ...
        if (!currentFormData.projectName.trim())
          newErrors.projectName = "Proje adı zorunludur";
        if (!currentFormData.projectDescription.trim()) {
          newErrors.projectDescription = "Proje açıklaması zorunludur";
        } else if (currentFormData.projectDescription.trim().length < 20) {
  ...
  const nextStep = () => {
    // Step değiştirmeden önce DOM'dan güncel değerleri topla ve state'e kaydet
    const currentFormData = collectFormData();
  ...
  // Form verilerini DOM'dan topla
  const collectFormData = () => {
    const data = { ...formData }; // Mevcut data'yı başlangıç olarak al
    ...
    // DOM'dan alınanları state'teki değerlerle birleştir
    return {
      ...data,
      firstName,
      lastName,
      ...
      projectName,
      projectDescription,
      // Select değerleri state'te kalır (handleSelectionChange ile güncellenir)
    };
  };
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 overflow-x-hidden w-full max-w-full">
                          ...
                          >
                            <input
                              ...
                              className="h-12 w-full px-3 py-2 text-base border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800"
                            />
                          </FormField>
                      ...
                      <div className="space-y-8 overflow-x-hidden w-full max-w-full">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-x-hidden w-full max-w-full">
                            {serviceAreas.map((area) => (
                              <div
                                ...
                                onClick={() => {
                                  handleSelectionChange("serviceArea", area.id);
                                  handleSelectionChange("serviceSubcategory", "");
                                  handleSelectionChange("productCategory", "");
                                }}
                              >
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 text-base border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800"
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleSelectionChange("targetMarket", value)
                            }
                          >
