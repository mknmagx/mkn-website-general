    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <section className="py-16 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">
              Sanal Tesis Turu - 360° Üretim Deneyimi
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Modern <strong>contract manufacturing tesislerimizi</strong> sanal
              olarak gezin ve
              <strong>fason üretim süreçlerimizi</strong> yakından görün. ISO
              sertifikalı kalite standartlarımızı ve teknoloji altyapımızı
              keşfedin.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative aspect-video rounded-xl overflow-hidden shadow-lg hover:shadow-xl dark:shadow-gray-800/50 dark:hover:shadow-gray-800/60 group cursor-pointer transition-shadow duration-300">
                <Image
                  src="/modern-pharmaceutical-manufacturing-facility-with-.png"
                  alt="Aspar İlaç Tesisi 360° Tur - Kozmetik Contract Manufacturing"
                  width={600}
                  height={338}
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button
                    variant="secondary"
                    className="bg-white/90 dark:bg-slate-800/90 hover:bg-white dark:hover:bg-slate-700 text-gray-900 dark:text-gray-100"
                    size="lg"
                  >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/80 dark:from-slate-900/80 to-transparent p-4">
                  <h3 className="text-white dark:text-gray-100 font-bold text-lg">
                    Aspar İlaç Contract Manufacturing Tesisi
                  </h3>
                  <p className="text-blue-100 dark:text-gray-300 text-sm">
                    ISO 22716 GMP • Kozmetik & Gıda Takviyesi Üretimi
                  </p>
                </div>
              </div>
              ...
              <div className="relative aspect-video rounded-xl overflow-hidden shadow-lg hover:shadow-xl dark:shadow-gray-800/50 dark:hover:shadow-gray-800/60 group cursor-pointer transition-shadow duration-300">
                <Image
                  ...
                  alt="Doğukan Kimya Tesisi 360° Tur - Temizlik Ürünleri Fason Üretimi"
                  width={600}
                  height={338}
                  className="w-full h-full object-cover"
                />
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/80 dark:from-slate-900/80 to-transparent p-4">
                  <h3 className="text-white dark:text-gray-100 font-bold text-lg">
                    Doğukan Kimya Fason Üretim Tesisi
                  </h3>
                  <p className="text-blue-100 dark:text-gray-300 text-sm">
                    ISO 14001 Çevre Dostu • Temizlik Ürünleri Contract
                    Manufacturing
                  </p>
                </div>
              </div>
