...
export default function ProductDetailPage({ params }) {
  ...
  useEffect(() => {
    async function loadProduct() {
      try {
        ...
        if (resolvedParams?.slug) {
          // Find product by slug in the products array
    ...
    loadProduct();
  }, []); // Empty dependency array since params is stable
  ...
  const handleWhatsAppContact = () => {
    // WhatsApp business number for MKN Group
    const whatsappNumber = "905314942594"; // +90 531 594 25 94

    // Create detailed product message
  ...
  const testImageUrl =
    "https://res.cloudinary.com/dnfmvs2ci/image/upload/w_600,h_600,c_fill,g_center,f_auto,q_auto,dpr_auto/v1751736117/mkngroup/disc-top-cap-gold-white.jpg";
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={`https://mkngroup.com.tr/ambalaj/${slugifyTr(product.name)}`}
        ogImage={getCloudinaryUrl(product.images[0])}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              {/* Main Image - COMPLETELY NEW VERSION */}
              <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden aspect-square border-2 border-gray-200 dark:border-gray-700">
                ...
                >
                  {/* ZoomIn icon removed to eliminate hover effects */}
                </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg border border-blue-200 dark:border-blue-700">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Shampuan, saç kremi, duş jeli, vücut
                                      losyonu gibi kişisel bakım ürünleri için
                                      ideal.
                                    </p>
                                  </div>
                                </div>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg border border-green-200 dark:border-green-700">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Sıvı deterjan, yumuşatıcı ve diğer
                                      temizlik ürünleri için uygun.
                                    </p>
                                  </div>
                                </div>
                            ...
                            {product.category.includes("Krem Pompa") && (
                              <>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 rounded-lg border border-pink-200 dark:border-pink-700">
                                  <Package2 className="h-6 w-6 text-pink-600 flex-shrink-0 mt-1" />
                                  <div>
                                    <h5 className="font-medium text-gray-900 dark:text-gray-100 mb-1">
                                      Cilt Bakım Ürünleri
                                    </h5>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Yüz kremi, vücut kremi, güneş kremi gibi
                                      krem formundaki ürünler için.
                                    </p>
                                  </div>
                                </div>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded-lg border border-indigo-200 dark:border-indigo-700">
                                  <Package2 className="h-6 w-6 text-indigo-600 flex-shrink-0 mt-1" />
                                  <div>
                                    <h5 className="font-medium text-gray-900 dark:text-gray-100 mb-1">
                                      Medikal Ürünler
                                    </h5>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Topikal ilaçlar, merhem ve medikal kremler
                                      için güvenli dozlama.
                                    </p>
                                  </div>
                                </div>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-teal-50 to-teal-100 dark:from-teal-900/20 dark:to-teal-800/20 rounded-lg border border-teal-200 dark:border-teal-700">
                                  <Package2 className="h-6 w-6 text-teal-600 flex-shrink-0 mt-1" />
                                  <div>
                                    <h5 className="font-medium text-gray-900 dark:text-gray-100 mb-1">
                                      Saç Bakım Ürünleri
                                    </h5>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Saç maskesi, besleyici krem ve styling
                                      ürünleri için ideal.
                                    </p>
                                  </div>
                                </div>
                                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 rounded-lg border border-amber-200 dark:border-amber-700">
                                  <Package2 className="h-6 w-6 text-amber-600 flex-shrink-0 mt-1" />
                                  <div>
                                    <h5 className="font-medium text-gray-900 dark:text-gray-100 mb-1">
                                      Özel Krem Formülleri
                                    </h5>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                      Özel formüllü kremler ve yoğun kıvamlı
                                      ürünler için hassas dozlama.
                                    </p>
                                  </div>
                                </div>
                              </>
                                ...
                                <>
                                  <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg border border-blue-200 dark:border-blue-700">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Kişisel bakım ve güzellik ürünleri için
                                  ...
                                  <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg border border-green-200 dark:border-green-700">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Gıda güvenliği standartlarına uygun
                                        ambalaj çözümleri.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg border border-purple-200 dark:border-purple-700">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Endüstriyel kimyasallar ve özel çözümler
                                        için dayanıklı ambalaj.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-lg border border-orange-200 dark:border-orange-700">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-600 dark:text-gray-400">
                                        İlaç ve sağlık ürünleri için güvenli ve
                                        hijyenik ambalaj.
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                          <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                              Bu ürün, {product.material?.toLowerCase()}{" "}
                              malzemesi ve {product.size} boyutu ile çeşitli
                              endüstriyel ve ticari uygulamalarda
                              kullanılabilir. Özel projeleriniz için teknik
                              özellikler ve uyumluluk bilgileri hakkında detaylı
                              bilgi almak üzere uzman ekibimizle iletişime
                              geçebilirsiniz.
                            </p>
              ...
              <CardContent className="p-8">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                    Uzman ekibimiz size en uygun çözümü bulmanızda yardımcı
                    olmaya hazır. Hemen iletişime geçin ve özel teklifimizi
                    alın.
                  </p>
