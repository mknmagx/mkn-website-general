...
export const metadata = {
  title: "Temizlik Ürünleri Fason Üretim | ISO 14001 Çevre Dostu | MKN GROUP",
  description:
  ...
  alternates: {
    canonical:
      "https://www.mkngroup.com.tr/fason-uretim/temizlik-urunleri-fason-uretim",
  },
  openGraph: {
    title: "Temizlik Ürünleri Fason Üretim | ISO 14001 Çevre Dostu | MKN GROUP",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "MKN GROUP Temizlik Ürünleri Fason Üretim Tesisleri",
      },
    ],
  },
  twitter: {
    ...
    images: [
      "https://www.mkngroup.com.tr/temizlik-urunleri-fason-uretim-og.jpg",
    ],
  },
  robots: {
    index: true,
            ...
            <div className="text-center mb-16">
              ...
              <div className="max-w-5xl mx-auto">
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                  <strong>MKN GROUP</strong>, 6+ yıllık deneyimi ve ISO 14001
                  çevre dostu sertifikalı 10.000 m² üretim tesisleriyle
                  Türkiye'nin lider temizlik ürünleri fason üretim firmasıdır.
                  Sıvı sabun, deterjan, yüzey temizleyici ve endüstriyel
                  temizlik ürünleri olmak üzere tüm temizlik kategorilerinde{" "}
                  <strong>günlük 25.000 litre üretim kapasitesi</strong> ile
                  hizmet veriyoruz.
                </p>
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  300+ formülasyon deneyimimiz, 5 kişilik Ar-Ge ekibimiz ve 18+
                  kalite kontrol noktamız ile <strong>private label</strong>,{" "}
                  <strong>OEM</strong> ve <strong>ODM</strong> temizlik ürünleri
                  fason üretim hizmetlerinde sektörün standardını
                  belirlemekteyiz. Çevre dostu formülasyonlar, biyolojik
                  parçalanabilir ürünler ve sürdürülebilir üretim kapasitemizle
                  markanızın çevre bilincini destekliyoruz.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">
                  Neden MKN GROUP Temizlik Ürünleri Fason Üretim?
                </h3>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative">
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-500 to-teal-600 dark:from-blue-400 dark:to-teal-500 rounded-full"></div>
              ...
              <div className="space-y-12">
                {productionProcess.map((process, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-teal-600 dark:from-blue-400 dark:to-teal-500 rounded-full text-white font-bold text-lg shadow-lg">
                      {process.step}
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                10.000 m² çevre dostu tesiste, son teknoloji ekipmanlarla günlük
                25.000 litre üretim kapasitesi
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-teal-700 dark:from-blue-700 dark:to-teal-800 rounded-2xl p-8 text-white">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">
                    Temizlik Ürünleri Fason Üretim Maliyet Avantajları
                  </h3>
                  <div className="space-y-3">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Her temizlik ürünü kategorisinde derin uzmanlık ve çevre dostu
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Biyolojik parçalanabilir, fosfat içermeyen ve doğa dostu
                  ...
                  <div className="border-l-4 border-teal-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      %99.9 bakteri öldürücü, virüs etkili antibakteriyel el
                      sabunu ve yüzey temizleyicileri
                    </p>
                  </div>
                  <div className="border-l-4 border-green-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Ağır hizmet tipi endüstriyel temizlik için özel
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-orange-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Enerji tasarruflu soğuk karışım ile çevre dostu üretim
                      prosesleri
                    </p>
                  </div>
                  <div className="border-l-4 border-red-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Az su kullanımı ile yüksek konsantrasyonlu etkili temizlik
                      ürünleri
                    </p>
                  </div>
                  <div className="border-l-4 border-purple-500 pl-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Üstün temizlik performansı için mikroemülsiyon sistemi
                      üretim teknolojisi
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                  Her üretim aşamasında 18+ kalite kontrol noktası ile %100
                  güvenli ve etkili ürünler
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Gelen her hammaddenin kimyasal analizi ve çevre uyumluluğu
                    testleri
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Üretim sırasında pH, viskozite, köpürme ve temizlik
                    etkinliği testleri
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Mikrobiyal güvenlik, biyolojik parçalanabilirlik ve
                    performans testleri
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Temizlik ürünleri fason üretim süreciyle ilgili merak ettiğiniz
                her şey
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                {
                  question:
                    "Minimum temizlik ürünleri fason üretim miktarı nedir?",
                  answer:
                    "Ürün tipine göre değişmekle birlikte, minimum 1.000 litre üretim yapabiliyoruz. Sıvı sabun ve deterjan ürünlerde 1.000 litre, konsantre ürünlerde 500 litre minimum üretim miktarımızdır.",
                },
                {
                  question: "Temizlik ürünleri fason üretim süresi ne kadar?",
                  answer:
                    "Numune onayından sonra seri üretime geçiş 10-20 gün arasında tamamlanır. Acil durumlar için 5-8 günde teslimat yapabiliyoruz. Formülasyon geliştirme süreci dahil olmak üzere toplam süre 15-25 gündür.",
                },
                {
                  question: "Hangi çevre dostu sertifikalara sahipsiniz?",
                  answer:
                    "ISO 14001 Çevre Yönetim Sistemi, Ekolabel, REACH uyumluluğu, GMP, biyolojik parçalanabilirlik sertifikalarına sahibiz. Ayrıca AB çevre standartlarında üretim kapasitemiz bulunmaktadır.",
                },
                {
                  question:
                    "Private label temizlik ürünleri üretimi yapıyor musunuz?",
                  answer:
                    "Evet, private label temizlik ürünleri üretimi ana hizmetlerimizden biridir. Kendi markanız için formülasyon geliştirme, ambalaj tasarımı, etiket tasarımı dahil olmak üzere A'dan Z'ye hizmet veriyoruz.",
                },
                {
                  question:
                    "Temizlik ürünleri fason üretim maliyeti nasıl hesaplanır?",
                  answer:
                    "Maliyet; ürün tipi, formülasyon karmaşıklığı, ambalaj türü, üretim miktarı ve hammadde kalitesine göre belirlenir. Çevre dostu formülasyonlar, antibakteriyel ürünler ve endüstriyel temizlik ürünleri için farklı fiyatlandırma uygulanır.",
                },
                {
                  question:
                    "Organik ve doğal temizlik ürünleri üretimi yapabiliyor musunuz?",
                  answer:
                    "Evet, sertifikalı organik ve doğal ham maddeler kullanarak ekolojik temizlik ürünleri üretimi yapıyoruz. Biyolojik parçalanabilir formülasyonlar ve çevre dostu üretim prosesleri konusunda uzmanlığımız bulunmaktadır.",
                },
                {
                  question:
                    "Temizlik ürünleri fason üretimde kalite garantisi var mı?",
                  answer:
                    "Tüm ürünlerimiz için ISO 14001 ve GMP standartlarında kalite garantisi veriyoruz. Üretim sürecinde 18+ kalite kontrol noktası bulunmaktadır ve nihai ürünler için tam analiz raporu sunuyoruz.",
                },
                {
                  question:
                    "İhracat için temizlik ürünleri üretimi yapıyor musunuz?",
                  answer:
                    "Evet, ihracat standartlarında temizlik ürünleri üretimi yapıyoruz. AB, ABD, Orta Doğu ülkeleri için gerekli çevre ve kalite sertifikasyonu desteği sağlıyoruz.",
                },
              ].map((faq, index) => (
                <Card
                  key={index}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <Card className="border-0 shadow-lg dark:shadow-slate-800/50 bg-white dark:bg-slate-800 text-center">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    6 ay içinde 20+ çevre dostu ürün geliştirerek organik
                    temizlik pazarında lider konuma geldi.
                  </p>
              ...
              <Card className="border-0 shadow-lg dark:shadow-slate-800/50 bg-white dark:bg-slate-800 text-center">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Ağır hizmet tipi endüstriyel formülasyonları ile Avrupa
                    pazarına başarılı giriş ve 8 ülkeye ihracat.
                  </p>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Ürün Kategorisi:</span>
              ...
              <Card className="border-0 shadow-lg dark:shadow-slate-800/50 bg-white dark:bg-slate-800 text-center">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Pandemi döneminde antibakteriyel ürün serisi ile hijyen
                    pazarında güçlü konum elde etti.
                  </p>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Ürün Kategorisi:</span>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-teal-700 dark:from-blue-700 dark:to-teal-800 rounded-2xl p-8 text-center text-white">
              ...
              <p className="text-blue-100 dark:text-blue-200 mb-6 max-w-2xl mx-auto">
                Temizlik ürünleri fason üretim hizmetlerimizle markanızı büyütün
                ve pazarda fark yaratın.
              </p>
