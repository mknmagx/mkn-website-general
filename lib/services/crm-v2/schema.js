...
// =============================================================================
// Conversation artık MÜŞTERİ BAZLI - bir müşterinin TÜM kanallardan mesajları
// tek bir conversation altında birleştirilir.
// 
// Conversation.channels: ['quote_form', 'whatsapp', 'email'] - kullanılan kanallar
// Conversation.primaryChannel: 'quote_form' - ilk mesajın geldiği kanal
// Message.channel: 'whatsapp' - her mesajın kendi kanalı var
// =============================================================================
...
export const ACTIVITY_TYPE = {
  ...
  // AI Özetleri
  AI_SUMMARY_ADDED: 'ai_summary_added',
  AI_SUMMARY_DELETED: 'ai_summary_deleted',
...
export const getActivityTypeLabel = (type) => {
  const labels = {
    ...
    [ACTIVITY_TYPE.AI_SUMMARY_ADDED]: 'AI özeti oluşturuldu',
    [ACTIVITY_TYPE.AI_SUMMARY_DELETED]: 'AI özeti silindi',
...
export const getActivityColor = (type) => {
  const colors = {
    ...
    [ACTIVITY_TYPE.AI_SUMMARY_ADDED]: 'text-purple-600',
    [ACTIVITY_TYPE.AI_SUMMARY_DELETED]: 'text-purple-400',
...
export const getActivityBgColor = (type) => {
  const colors = {
    ...
    [ACTIVITY_TYPE.AI_SUMMARY_ADDED]: 'bg-purple-50',
    [ACTIVITY_TYPE.AI_SUMMARY_DELETED]: 'bg-purple-50',
...
export const getActivityIcon = (type) => {
  ...
  const icons = {
    ...
    [ACTIVITY_TYPE.AI_SUMMARY_ADDED]: 'Sparkles',
    [ACTIVITY_TYPE.AI_SUMMARY_DELETED]: 'Sparkles',
...
export const COLLECTIONS = {
  ...
  REMINDERS: 'crm_reminders', // Merkezi hatırlatma koleksiyonu
...
export const REMINDER_TYPE = {
  ...
  ONLINE_MEETING: 'online_meeting', // Çevrimiçi görüşme
  FACE_TO_FACE: 'face_to_face',     // Yüz yüze görüşme
  CALL: 'call',                     // Arama hatırlatması
  PRICE_QUOTE: 'price_quote',       // Fiyat teklifi hazırlama
};
...
export const getReminderTypeLabel = (type) => {
  const labels = {
    ...
    [REMINDER_TYPE.ONLINE_MEETING]: 'Çevrimiçi Görüşme',
    [REMINDER_TYPE.FACE_TO_FACE]: 'Yüz Yüze Görüşme',
    [REMINDER_TYPE.CALL]: 'Arama',
    [REMINDER_TYPE.PRICE_QUOTE]: 'Fiyat Teklifi',
  };
  return labels[type] || type;
};
...
export const getReminderTypeColor = (type) => {
  const colors = {
    ...
    [REMINDER_TYPE.ONLINE_MEETING]: 'bg-indigo-100 text-indigo-700 border-indigo-200',
    [REMINDER_TYPE.FACE_TO_FACE]: 'bg-emerald-100 text-emerald-700 border-emerald-200',
    [REMINDER_TYPE.CALL]: 'bg-teal-100 text-teal-700 border-teal-200',
    [REMINDER_TYPE.PRICE_QUOTE]: 'bg-pink-100 text-pink-700 border-pink-200',
  };
  return colors[type] || 'bg-gray-100 text-gray-700 border-gray-200';
};
...
export const getReminderTypeIcon = (type) => {
  const icons = {
    [REMINDER_TYPE.FOLLOW_UP]: 'RefreshCw',
    [REMINDER_TYPE.DEADLINE]: 'AlertTriangle',
    [REMINDER_TYPE.SLA_WARNING]: 'Clock',
    [REMINDER_TYPE.CUSTOM]: 'Bell',
    [REMINDER_TYPE.QUOTE_FOLLOW_UP]: 'FileText',
    [REMINDER_TYPE.INACTIVITY]: 'ZZZ',
    [REMINDER_TYPE.ONLINE_MEETING]: 'Video',
    [REMINDER_TYPE.FACE_TO_FACE]: 'Users',
    [REMINDER_TYPE.CALL]: 'Phone',
    [REMINDER_TYPE.PRICE_QUOTE]: 'DollarSign',
  };
