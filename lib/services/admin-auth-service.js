...
export const hasPermission = async (permissions, permissionKey, userId = null, userEmail = null, userRole = null) => {
  const allowed = permissions && permissions[permissionKey] === true;
...
export const requirePermission = async (permissions, permissionKey, userId = null, userEmail = null, userRole = null) => {
  const allowed = await hasPermission(permissions, permissionKey, userId, userEmail, userRole);
