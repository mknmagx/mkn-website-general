...
export const submitContactForm = async (formData) => {
  try {
    // Form verisini admin panel'in beklediği yapıya göre düzenle
    const contactData = {
      // Temel iletişim bilgileri (admin panel bunları bekliyor)
    ...
    // Firestore'a kaydet
    const docId = await addDocument('contacts', contactData);
