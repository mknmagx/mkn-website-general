...
export const PROMPT_CONTEXTS = {
  ...
  CRM_CASE_SUMMARY: "crm_case_summary",
...
export const PROMPT_CATEGORIES = {
  CHAT: "chat",
  CRM_COMMUNICATION: "crm_communication", // CRM İletişim Teklifi
  CRM_CASE_SUMMARY: "crm_case_summary", // CRM Talep Özeti
  FORMULA: "formula",
...
SADECE yanıt metnini döndür. Başlık/yorum/ek not yazma.`,
  ...
  // ==========================================================================
  // CRM TALEP ÖZETİ PROMPT - v1.0
  // Müşteri konuşmalarından talep özeti çıkaran AI promptu
  // ==========================================================================
  {
    key: "crm_case_summary",
    name: "CRM Talep Özeti Prompt'u",
    description: "Müşteri konuşmalarını analiz ederek net ve yapılandırılmış talep özeti üretir",
    category: PROMPT_CATEGORIES.CRM_CASE_SUMMARY,
    context: PROMPT_CONTEXTS.CRM_CASE_SUMMARY,
    isActive: true,
    version: "1.0",
