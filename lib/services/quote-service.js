...
export const submitQuoteRequest = async (formData) => {
  try {
    console.log("quote-service: Received form data:", formData);
    ...
    console.log("quote-service: Prepared quote data for Firestore:", quoteData);

    // Firestore'a kaydet
    const docId = await addDocument('quote-requests', quoteData);
