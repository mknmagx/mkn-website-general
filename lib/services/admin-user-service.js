...
export const getAllUsers = async (currentUserPermissions) => {
  try {
    requirePermission(currentUserPermissions, "canManageUsers");
...
export const getUserStats = async (currentUserPermissions) => {
  try {
    requirePermission(currentUserPermissions, "canViewAnalytics");
...
export const getAdminUsers = async (currentUserPermissions) => {
  try {
    requirePermission(currentUserPermissions, "canManageAdmins");
