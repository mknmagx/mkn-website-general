 ...
 * ====================================================
 * Bu servis artık DEPRECATED olarak işaretlenmiştır.
 * 
 * Tüm müşteri yönetimi CRM v2 üzerinden yapılmalıdır:
 * - Müşteri oluşturma: /lib/services/crm-v2/customer-service.js
 * - Müşteri arama: findCustomerByContact()
 * - WhatsApp entegrasyonu: CRM customers otomatik oluşturulur
 * 
 * WhatsApp kişileri CRM müşterilerine taşınabilir:
 * - Admin Panel: /admin/crm-v2/settings > "WhatsApp Rehber → CRM"
 * - API: POST /api/admin/crm-v2/whatsapp-migration
 * 
 * Bu servis geriye uyumluluk için korunmaktadır ancak
 * yeni geliştirmelerde KULLANILMAMALIDIR.
 * ====================================================
 */
