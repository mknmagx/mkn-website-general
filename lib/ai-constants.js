...
export const AI_CONTEXTS = {
  ...
  // === CRM === 
  CRM_COMMUNICATION: "crm_communication",       // İletişim teklifi
  CRM_CASE_SUMMARY: "crm_case_summary",         // Talep özeti - konuşmadan özet çıkarma
  CRM_CONVERSATION_SUMMARY: "crm_conversation_summary", // Konuşma hızlı özeti - inbox detay için
  
  // === WhatsApp ===
  WHATSAPP_TEXT_REVISION: "whatsapp_text_revision", // WhatsApp mesaj düzeltme
...
export const CONTEXT_DISPLAY_NAMES = {
  ...
  [AI_CONTEXTS.CRM_CASE_SUMMARY]: "CRM - Talep Özeti",
  
  // WhatsApp
  [AI_CONTEXTS.WHATSAPP_TEXT_REVISION]: "WhatsApp - Metin Düzeltme",
  ...
  // Content Studio
  [AI_CONTEXTS.CONTENT_VISUAL_GENERATION]: "Content Studio - Görsel Üretimi (AI)",
  [AI_CONTEXTS.CONTENT_STUDIO_GENERATION]: "Content Studio - İçerik Üretimi (AI)",
